define(['../type', './layout/any', './isNull', './fields'], function (
            type,            any,     isNull,     fields) {
    ...
    Field.prototype.getAs = function (Derefable) {
        ...
        if (isNull(this._pointer) && Derefable._CT.meta===1)
            throw new ValueError('Cannot cast a null pointer to a list type');

        return Derefable._deref(
            this._arena,
            this._pointer,
            this._parent._depth + 1
        );
    };
