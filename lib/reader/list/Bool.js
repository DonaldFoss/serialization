define(['../../type', '../primitives', './statics', './methods'], function (
               type,      primitives,     statics,     methods) {
    ...
    Bools.prototype.get = function (index) {
        ...
        if (this._dataBytes === null) {
             ...
             * structures.
             */
            return !!primitives.bool(this._segment, this._begin + index*this._stride, 0x00);
        }
    };
