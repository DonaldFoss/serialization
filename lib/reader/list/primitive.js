define(['../../type', './statics', './methods'], function (
    ...
    return function (decoder, ct, hash) {
        ...
        var Primitives = function (arena, depth, isOrphan, layout) {
            ...
            arena.limiter.read(
                layout.segment,
                layout.begin,
                layout.dataBytes * layout.length
            );
        };
        ...
        switch (ct.layout) {
        case 2: Primitives._B64_NULL = 'AQAAAAIAAAA='; break;
        case 3: Primitives._B64_NULL = 'AQAAAAMAAAA='; break;
        case 4: Primitives._B64_NULL = 'AQAAAAQAAAA='; break;
        case 5: Primitives._B64_NULL = 'AQAAAAUAAAA='; break;
        default: throw new Error('Unexpected primitive layout');
        }
