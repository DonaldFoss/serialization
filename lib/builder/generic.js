    ...
    return function (Reader) {
        ...
        var Generic = {
                    ...
                    _memoize : function (specialHash, params) {
                        ...
                        if (Structure === undefined) {
                            Structure = specialize(
                                Reader._memoize(specialHash, params),
                                parent,
                                params,
            ...
            bindScope : function (parent) {
                return Generic.memoizeScope(
                    parent._HASH + ':' + Reader._ID,
                    parent
                );
            },
            ...
            memoizeScope : function (scopedHash, parent) {
                ...
                if (ScopedGeneric === undefined) {
                    ScopedGeneric = Generic.fixScope(
                        Reader.memoizeScope(scopedHash, parent._READER),
                        parent
                    );
