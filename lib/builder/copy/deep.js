define(['../reader/layouts/any', '../reader/list/sizes', './layout/structure', './layout/list'], function(
                           any,                  sizes,            structure,            list) {
    ...
    var setListPointer = function (arena, layout, targetArena, target) {
        ...
        } else if (meta.size === 0x01) {
            blob = arena._preallocate(
                target.segment,
