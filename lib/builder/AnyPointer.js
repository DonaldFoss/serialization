define(['../reader/AnyPointer', '../reader/isNull', '../reader/list/meta', '../reader/layout/any', './copy/pointer', './layout/index', './fields', './Data', './Text'], function (
                       Reader,             isNull,              listMeta,                    any,     copy,             layout,           fields,     Data,     Text) {
    ...
    var disownAs = function (Type, context) {
        if (isNull(context._pointer) && Type._CT.meta === 1)
    ...
    Field.has = function (offset) {
        return function () { return has(this, offset); };
    };
    ...
    Field.prototype.adopt = function (value) {
        ...
        if (!value._arena.isEquivTo(this._arena))
            throw new ValueError('Cannot adopt from a different arena');

        if (this._discr)
            this._parent._setWhich(this._discr);
    ...
    Any._set = function (arena, pointer, value) {
        if (value._layout !== undefined) {
            ...
            if (layout.meta === 1)
                copy.setListPointer(value._arena, layout, arena, pointer);
            else
                copy.setStructPointer(value._arena, layout, arena, pointer);
        } else if (typeof value === 'string')
            Text._set(arena, pointer, value);
