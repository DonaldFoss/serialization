define(['./Arena'], function (Arena) {
    ...
    arena.getRoot(Struct); // Struct.deref(arena, arena.getSegment(0), 0);
    arena.setRoot(readerStructInstanceThatGetsDeepCopied); // ?reader.initOrphan(arena); => incorporate as orphan, then arena.adoptRoot(orphan);
