define(['../reader/layout/structure', '../reader/methods', './layout/structure', './copy/pointer', './fields', './upgrade'], function (
            reader,                              methods,              builder,     copy,             fields,     upgrade) {
    ...
    return function (Reader) {
        ...
        Structure._FIELD.unionAdopt = function (discr, offset) {
            return function (value) {
                if (!Structure._TYPE.equiv(value._TYPE))
                    throw new TypeError();
        ...
        Structure._FIELD.set = function (offset) {
            return function (value) {
                if (Structure._TYPE !== value._TYPE)
                    throw new TypeError();
