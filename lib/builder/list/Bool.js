define(['../../reader/list/Bool', '../../reader/layout/list', '../copy/deep', '../layout/list', './statics', './methods', '../primitives'], function (
               Reader,                   reader,                  copy,               builder,     statics,     methods,      primitives) {
    ...
    Bools._init = function (arena, pointer, length) {
        var ell = (length >>> 3) + (length & 0x07 ? 1 : 0);
