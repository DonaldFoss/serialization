define(['../../reader/list/index', '../primitives', '../Data', '../Text', './structure', './pointer', './Void', './Bool', './primitive'], function (
               reader,                     encode,      Data,      Text,     structure,     pointer,     Void,     Bool,     primitive) {
