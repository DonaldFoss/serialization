define(['../reader/isNull', './copy/pointer', './primitives', './layout/index'], function (
                   isNull,     copy,             primitives,     layout) {
        ...
        list : {
            adopt : function () {
                return function (context, offset, value) {
                    ...
                    if (!context._arena.isEquivTo(value._arena))
