define(['../reader/layout/any', '../reader/list/meta', '../reader/isNull'], function(
                          any,                  meta,             isNull) {
    ...
    var zeroFarLanding = function (arena, pointer) {
        ...
        var typeBits = pointer.segment[pointer.position] & 0x07;
        if (typeBits === 2) {
            var doubleIncrement = (pointer.segment[pointer.position] & 0x04) << 1;
