define([], function() {
    return function(List, layout) {
        return function(segments, segment, position) {
            ...
            } else if (segment[position] === 0 & segment[position + 1] === 0 & segment[position + 2] === 0 & segment[position + 3] === 0 & segment[position + 4] === 0 & segment[position + 5] === 0 & segment[position + 6] === 0 & segment[position + 7] === 0) {
