define([ "../../primitives", "../primitives/layout" ], function(primitives, layout) {
    var sizes = [ {
        data: 0,
        pointers: 0
    }, {
    ...
    var localLayout = function(segment, position) {
        ...
        switch (c) {
          ...
          default:
            return subwordLayout(start, sizes[c], layout.cardinality(segment, position));
        }
    };
    /*
    ...
    var doubleFarLayout = function(segment, position, targetSegment) {
        ...
        switch (c) {
          ...
          default:
            return subwordLayout(start, sizes[c], layout.cardinality(segment, position + 8));
        }
    };
