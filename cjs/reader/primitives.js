    ...
    module.exports = {
        bool: function(bytes, position, bitPosition) {
            return (bytes[position] << bitPosition & 128) >>> 7 | 0;
        },
        ...
        int64ish: function(bytes, position) {
             ...
             */
            return [ int32(bytes, position + 4) | 0, uint32(bytes, position) >>> 0 ];
        },
        ...
        uint64: function(bytes, position) {
             ...
             * annotation for targeting `int64`.
             */
            return [ uint32(bytes, position + 4) >>> 0, uint32(bytes, position) >>> 0 ];
        },
